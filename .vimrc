...
let g:DoxygenToolkit_authorName="Reage(rentiansheng@163.com)"
let g:DoxygenToolkit_licenseTag="license \<enter> no \<enter>@file: \<enter>@data: \<enter> description  \<enter>"
